...
<tr>
	...
	<th width="25%" class="thTop" nowrap="nowrap">&nbsp;{L_FORUM}&nbsp;</th>
	<th width="75%" class="thTop" nowrap="nowrap">&nbsp;{L_TOPICS}&nbsp;</th>
...
<tr>
	...
	<td class="row2"><span class="topictitle" onmousedown="document.getElementById('tid_{searchresults.TOPIC_ID}').className='opened'">{searchresults.NEWEST_POST_IMG}{searchresults.TOPIC_TYPE}<a href="{searchresults.U_VIEW_TOPIC}" class="topictitle"><span id="tid_{searchresults.TOPIC_ID}">{searchresults.TOPIC_TITLE}</span></a></span><br /><span class="gensmall">{searchresults.GOTO_PAGE}</span></td>
	...
	<td class="row2" align="center" valign="middle" nowrap="nowrap"><span class="postdetails">{searchresults.LAST_POST_TIME}<br />{searchresults.LAST_POST_AUTHOR} <span onmousedown="document.getElementById('tid_{searchresults.TOPIC_ID}').className='opened'">{searchresults.LAST_POST_IMG}</span></span></td>
</tr>
<!-- END searchresults -->
<tr>
