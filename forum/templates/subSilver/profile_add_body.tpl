...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr>
		<th colspan="2" class="thSides" height="25" valign="middle"><a name="bittorrent">TorrentPier</th>
	</tr>
	<tr>
		<td class="row1" height="32" valign="middle"><span class="gen">{L_GEN_PASSKEY}</span><br /><span class="gensmall">{L_GEN_PASSKEY_EXPLAIN}</span></td>
		<td class="row2"><span class="gensmall">{L_GEN_PASSKEY_EXPLAIN_2}</span><br /><span class="genmed">{S_GEN_PASSKEY}</span></td>
	</tr>
	<tr>
		<td class="row1" height="32" valign="middle"><span class="gen">{L_CURR_PASSKEY}</span></td>
		<td class="row2"><span class="gen">{CURR_PASSKEY}</span></td>
	</tr>
	<tr>
