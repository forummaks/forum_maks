...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr>
		<th class="thCornerL" height="26">{L_AUTHOR}</th>
		<th class="thCornerR">{L_MESSAGE}</th>
	</tr>
	<!-- BEGIN postrow -->
	<tr>
		<td align="left" valign="top" class="{postrow.ROW_CLASS}"><a name="{postrow.U_POST_ID}"></a><span class="genmed" title="{L_INS_NAME_TIP}" onmouseout="bbcode && bbcode.refreshSelection(false)" onmouseover="bbcode && bbcode.refreshSelection(true)" onclick="bbcode && bbcode.onclickPoster('{postrow.POSTER_NAME}'); return false"><a href="#" class="genmed" onclick="return false"><b>{postrow.POSTER_NAME}</b></a></span><br /><img src="images/spacer.gif" width="122" height="4" border="0" alt="" /></td>
		<td width="100%" class="{postrow.ROW_CLASS}" height="28" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
