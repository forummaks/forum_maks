<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<!-- BEGIN catrow -->
	<tr>
		<td class="cat" style="padding: 2px 2px 2px 6px; height: 21px"><span class="cattitle">{catrow.ADMIN_CATEGORY}</span></td>
	</tr>
	<!-- BEGIN modulerow -->
	<tr class="row1">
		<td class="genmed" style="padding-left: 4px"><a href="{catrow.modulerow.U_ADMIN_MODULE}" target="main" class="genmed">{catrow.modulerow.ADMIN_MODULE}</a></td>
	</tr>
	<!-- END modulerow -->
	<!-- END catrow -->
</table>
