...
<table width="98%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	<tr>
	...
	<!-- END userrow -->
	<tr>
		<td class="row3" colspan="9"><img src="../templates/subSilver/images/spacer.gif" width="1" height="1" alt="."></td>
	</tr>
</table>
