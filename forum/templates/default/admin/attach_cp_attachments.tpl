...
<form method="post" name="attach_list" action="{S_MODE_ACTION}">
  ...
  <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<tr>
	  ...
	  <td class="{attachrow.ROW_CLASS}" align="center" valign="middle"><span class="gen"><input type="text" size="5" maxlength="10" name="attach_count_list[]" value="{attachrow.DOWNLOAD_COUNT}" class="post" /></span></td>
