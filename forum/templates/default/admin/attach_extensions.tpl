...
<form method="post" action="{S_ATTACH_ACTION}">
  <table width="100%" align="center" cellpadding="4" cellspacing="1" border="0" class="forumline">
	<tr>
	  <td class="catHead" colspan="4" align="center" height="28"><span class="cattitle">{L_EXTENSIONS_TITLE}</span>
	  </td>
	</tr>
	<tr>
	...
	<tr align="right">
	  <td class="catBottom" colspan="4" height="29"> {S_HIDDEN_FIELDS} <input type="submit" name="submit" class="liteoption" value="{L_SUBMIT}" /></td>
    </tr>
	<tr>
	  <th class="thLeft">&nbsp;{L_EXPLANATION}&nbsp;</th>
	  <th>&nbsp;{L_EXTENSION}&nbsp;</th>
...
<!-- END extension_row -->
	<tr align="right">
	  <td class="catBottom" colspan="4" height="29">
