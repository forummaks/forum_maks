...
<table width="100%" align="center" cellpadding="4" cellspacing="1" border="0" class="forumline">
	<tr>
			<td class="catHead" colspan="3" align="center" height="28"><span class="cattitle">{L_SHADOW_TITLE}</span>
			</td>
	</tr>
	<tr>
	...
	<tr>
			<td class="spaceRow" colspan="3" align="center"><span class="gensmall">{L_EXPLAIN_FILE}</span></td>
	</tr>
  ...
  <!-- END file_shadow_row -->
	...
	<tr>
			<td class="spaceRow" colspan="3" align="center"><span class="gensmall">{L_EXPLAIN_ROW}</span></td>
	</tr>
