...
<head>
    ...
    <script language="JavaScript" type="text/javascript" src="{FT_ROOT}misc/js/imgfit.js"></script>
    <!-- ENDIF -->
    <!-- //qr end -->
    <script language="JavaScript" type="text/javascript" src="{FT_ROOT}misc/js/jquery.pack.js"></script>
    <script language="JavaScript" type="text/javascript" src="{FT_ROOT}misc/js/jquery.js"></script>
    ...
    <tr>
        <td class="bodyline">
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td><a href="{U_INDEX}"><img src="templates/default/images/logo.gif" border="0" alt="{L_INDEX}"
                                                 vspace="1"/></a></td>
                </tr>
            </table>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="left">
                            <!-- //bt -->
                            <!-- BEGIN user_ratio -->
                            <span class="mainmenu">Отдано: <span class="seedsmall"><b>{user_ratio.U_UP_TOTAL}</b></span> &#0183; Бонус: <span
                                        class="seedsmall"><b>{user_ratio.U_BONUS_TOTAL}</b></span> &#0183; Скачано: <span
                                        class="leechsmall"><b>{user_ratio.U_DOWN_TOTAL}</b></span> &#0183; Рейтинг: <span
                                        class="small"><b>{user_ratio.U_RATIO}</b></span></span>
                            <!-- END user_ratio -->
                            <!-- //bt end -->
                        </td>
                        <td align="center">
                        ...
                        <td align="right">
                            ...
                            <a href="{U_LOGIN_LOGOUT}" class="mainmenu"
                               onclick="return confirm('Выйти?');">{L_LOGIN_LOGOUT}</a>
                        </td>
                    </tr>
                </table>
            </div>
