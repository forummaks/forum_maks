	...
	<!-- BEGIN attach_row -->
    	...
    	<tr>
			...
			<td class="row2"><span class="genmed"><input type="text" name="comment_list[]" size="50" maxlength="255" style="width: 100%" class="post" value="{attach_row.FILE_COMMENT}" /></span></td>
		</tr>
    	<tr>
